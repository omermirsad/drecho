    ...
    return (
        <footer id="contact" className="bg-[#0f0f1a] pt-20 pb-10 px-4 sm:px-6 lg:px-8 border-t border-indigo-500/20">
            <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12">
                ...
                <div className="footer-section">
                    <h3 className="text-xl font-bold text-indigo-400 mb-4">Connect</h3>
                    <div className="flex gap-4 mt-2">
                        {socialLinks.map(link => (
                            <a key={link.name} href="#" className="w-10 h-10 bg-indigo-500/10 border border-indigo-500/30 rounded-full flex items-center justify-center text-slate-300 transition-all duration-300 hover:bg-indigo-500 hover:-translate-y-1 hover:shadow-lg hover:shadow-indigo-500/30">
